...
//		String sqlResults = null;
		 ...
		 * CTUMart website. Right now commented out due to the data/php site
		 * not put into the android yet.
		 */
		/*try {
		...
		try {
			...
			for (int i = 0; i < jsonArray.length(); i++) {
				...
				String aisle = jsonData.getString("aisle");
				pr1.setAisle(aisle);
		...
		/*
		 * creating an instance of ListView as well as setting an adapter to
		 * it to list the contents we have made.
		 */
